            ...
            <div formGroupName="store">
                <input 
                    ...
                    <div class="error" *ngIf="unknown">
                        Unkown branch, please check the ID
                    </div>
                <input 
                    type="text" 
...
export class StockBranchComponent {
    ...
    get unknown() {
        return (
            this.parent.get('store.branch').hasError('unknownBranch') && this.parent.get('store.branch').dirty 
        );
    }

    get invalid() {
        return (
            // we use dirty if the user interacted with
            // the field
